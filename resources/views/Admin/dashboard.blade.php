...
<head>
    ...
    <style>
        body { background-color: #121212; color: #f5f5f5; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        .sidebar { width: 240px; background-color: #1e1e2d; position: fixed; top:0; bottom:0; padding-top:60px; }
        .sidebar .nav-link { color: #aaa; padding:12px 20px; border-radius:10px; margin:4px 12px; transition:0.3s; }
        .sidebar .nav-link.active, .sidebar .nav-link:hover { background-color:#e11d48; color:#fff; }
        .navbar { margin-left:240px; background-color:#1e1e2d; box-shadow:0 2px 8px rgba(0,0,0,0.5); }
        .content { margin-left:260px; padding:30px; }
        .card-box { background-color:#1e1e2d; border:none; border-radius:15px; padding:20px; color:#fff; transition:0.3s; }
        .card-box:hover { transform:translateY(-5px); box-shadow:0 8px 20px rgba(0,0,0,0.4); }
        .card-icon { font-size:2.5rem; color:#e11d48; }
